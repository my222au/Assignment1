...
public class WeatherForecast {
    ...
    public String getstarttday(){return startDay;}
	...
	void setDay(String startPeriod, String endPeriod){
        startDay = TimeUtils.getDay(TimeUtils.getDate(startPeriod));
        endDay = TimeUtils.getDay(TimeUtils.getDate(endPeriod));
