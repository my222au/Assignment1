...
public class Beer {
    ...
    public String[] description = {"" +
        ...
        public int[] images = {
            R.drawable.morning_delight,
            R.drawable.goodmorning,
            R.drawable.pliny_the_younger,
            R.drawable.heady_topper,
            R.drawable.kentucky_brunch_brand_stout,
            R.drawable.russian_river_pliny_the_elder,
            R.drawable.norrlands};


    public  int [] beerName ={
            R.string.mornin_delight,
            R.string.good_morning,
            R.string.pliny_the_younger,
           R.string.heady_topper,
           R.string.kentucky_brunch_brand_stout,
            R.string.pliny_the_elder,
            R.string.norrlands_guld_export
